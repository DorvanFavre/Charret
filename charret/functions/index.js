        ...
        return admin.firestore().collection('Games').doc(gameDocId).get().then(
            async (game) => {
                ...
                function shouldRemoveToken() {
                    return combo('000', '001', '002') || combo('100', '101', '102') || combo('200', '201', '202') || combo('010', '110', '210') || combo('212', '112', '012') || combo('120', '121', '122') || combo('020', '021', '022') || combo('000', '010', '020') || combo('100', '110', '120') || combo('200', '210', '220') || combo('001', '101', '201') || combo('221', '121', '021') || combo('202', '212', '222') || combo('102', '112', '122') || combo('002', '012', '022');
